...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_split_3x6_3(
    KC_NO, KC_QUOT, KC_COMM,  KC_DOT,    KC_P,    KC_Y,        KC_F,    KC_G,    KC_C,    KC_R,    KC_L, QK_AREP,
    KC_NO,    KC_A,    KC_O,    KC_E,    KC_U,    KC_I,        KC_D,    KC_H,    KC_T,    KC_N,    KC_S, KC_LGUI,
    KC_NO, KC_SCLN,    KC_Q,    KC_J,    KC_K,    KC_X,        KC_B,    KC_M,    KC_W,    KC_V,    KC_Z, KC_RSFT,
                                ADJUST,   RAISE,  KC_SPC,     KC_BSPC,   LOWER, KC_LALT
    ),

  // layer 1 - Magic Sturdy -- leaving this one empty for now; implement later
